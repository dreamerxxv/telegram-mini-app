...
const Menu = () => {
    return (
        <div className="fixed z-50 h-12 max-w-sm w-2/3 -translate-x-1/2 bg-white border border-gray-200 rounded-full bottom-4 left-1/2 dark:bg-transparent dark:border-gray-600">
